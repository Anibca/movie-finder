...
const url = 'http://www.omdbapi.com/?i=tt3896198&apikey=2b778310';
...
searchButton.addEventListener('click', event => {
    ...
    const searchURL = `https://www.omdbapi.com/?s=${textValue}&apikey=2b778310`
...
function renderPopUp (movieId) {
    fetch (`https://www.omdbapi.com/?i=${movieId}&apikey=2b778310`)      //fetching the info 
    .then(res => res.json())
    .then(data => {
        // console.log(data);
